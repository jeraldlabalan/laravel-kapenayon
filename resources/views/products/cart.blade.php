                                    ...
                                    @foreach ($cartProducts as $cartProduct)
                                        <tr class="text-center">
                                            <td class="product-remove"><a
                                                    href="{{ route('cart.product.delete', $cartProduct->product_id) }}"><span
                ...
                <div class="col col-lg-3 col-md-6 mt-5 cart-wrap ftco-animate">
                    ...
                    @if ($cartProducts->count() > 0)
                        <form method="POST" action="{{ route('prepare.checkout') }}">
                            @csrf
                            <input type="text" name="price" value="{{ $totalPrice }}" hidden>
                            <button type="submit" name="submit" class="btn btn-primary py-3 px-4">Proceed to
                                Checkout</button>
                        @else
                            <button type="submit" name="submit" class="btn btn-primary py-3 px-4" disabled>Proceed to
                                Checkout</button>
                    @endif
                    </form>
